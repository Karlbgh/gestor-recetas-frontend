...
export const RECETAS_ROUTES: Routes = [
  ...
  //   title: 'Nueva Receta',
  //   canActivate: [AuthGuard] // Descomenta si quieres proteger esta ruta
  // },
  // {
  //   path: ':id', // Ruta para ver el detalle de una receta (ej: /recetas/123)
  //   component: RecetaDetailComponent,
  //   title: 'Detalle de Receta' // Podrías usar un Resolve para un título dinámico
  // },
  // {
  //   path: ':id/editar', // Ruta para editar una receta existente (ej: /recetas/123/editar)
  //   component: RecetaFormComponent,
  //   title: 'Editar Receta',
  //   canActivate: [AuthGuard] // Descomenta si quieres proteger esta ruta
  // },
